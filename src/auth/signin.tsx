...
const GoogleSignIn: React.FC<GoogleSignInProps> = ({
  ...
  const headerContent: React.ReactNode = (
    <div className="flex flex-column align-items-center gap-2 text-center">
      ...
      <h2 className="text-2xl font-bold m-0">Sign in with Google</h2>
      <p className="text-600 m-0">Use your Google Account</p>
    </div>
  );

  return (
    <div className="flex justify-content-center">
      <Card header={headerContent} className="w-full max-w-30rem">
        <form onSubmit={handleSubmit} className="flex flex-column gap-4">
          ...
          <div className="text-600 text-sm mt-4">
